...
Ti_Cd <- ggplot(data_Ti_Cd, aes(x = reorder(Genus, -Ti), y = Ti)) +
  ...
  annotate("text", x = 4 , y = 0.42,label = "Ti = 0.35",colour="black", size = 6)
Ti_Cd
#ggsave("Ti-Cd.pdf", Ti_Cd, width = 12, height = 7)
...
Ti_Pb <- ggplot(data_Ti_Pb, aes(x = reorder(Genus, -Ti), y = Ti)) +
  ...
  annotate("text", x = 4 , y = 0.42,label = "Ti = 0.35",colour="black", size = 6)
Ti_Pb
ggsave("Ti_Pb.pdf", Ti_Pb, width = 12, height = 7)
...
Ti_Cu
ggsave("Ti_Cu.pdf", Ti_Cu, width = 6, height = 7)
...
Ti_Zn <- ggplot(data_Ti_Zn, aes(x = reorder(Genus, -Ti), y = Ti)) +
  ...
  annotate("text", x = 1 , y = 0.42,label = "Ti = 0.35",colour="black", size = 6)
Ti_Zn
ggsave("Ti_Zn.pdf", Ti_Zn, width = 6, height = 7)
...
Ti_Sb <- ggplot(data_Ti_Sb, aes(x = reorder(Genus, -Ti), y = Ti)) +
  ...
  annotate("text", x = 1 , y = 0.42,label = "Ti = 0.35",colour="black", size = 6)
Ti_Sb
ggsave("Ti_Sb.pdf", Ti_Sb, width = 4, height = 7)
```
...
#"bdod", "cfvo", "clay", "nitrogen", "ocd", 
#"ocs", "phh2o", "sand", "silt", "soc", "wrb". See Details



#####pH(H2O)#####
gph <- soil_world("phh2o",depth=30, path=tempdir())
...
#Plot
plot(gbd, ylim = c(-60,90), xlim = c(-180,180),
     col = colorRampPalette(c("#3288BD","#66C2A5","#FEE08B","#D53E4F"))(250))
...
#####Soil SOC#####
gsoc <- soil_world("soc",depth=30, path=tempdir())

#Plot
plot(gsoc, ylim = c(-60,90), xlim = c(-180,180),
     col = colorRampPalette(c("#3288BD","#66C2A5","#FEE08B","#D53E4F"))(250))
...
#####Soil TN#####
gtn <- soil_world("nitrogen",depth=30, path=tempdir())

#Plot
plot(gtn, ylim = c(-60,90), xlim = c(-180,180),
     col = colorRampPalette(c("#3288BD","#66C2A5","#FEE08B","#D53E4F"))(250))
